...
namespace SuperMemoAssistant.Plugins.MouseOverWiki
{
  ...
  IsDefault = true,
  Validates = true)]
  public class MouseoverWikiCfg : CfgBase<MouseoverWikiCfg>, INotifyPropertyChangedEx
  {
    [Title("Mouseover Wiki Plugin")]
    [Heading("By Jamesb | Experimental Learning")]

    [Heading("Features")]
    [Text(@"- Adds content to Wikipedia link popup preview windows.")]
    ...
    {
      return "Mouseover Wiki Settings";
    }
